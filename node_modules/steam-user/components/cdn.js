...
class SteamUserCDN extends SteamUserApps {
	 ...
	 * @return Promise
	 */
	getCDNAuthToken2(appID, depotID, hostname, callback) {
		return StdLib.Promises.timeoutCallbackPromise(0, ['token', 'expires'], callback, (resolve, reject) => {
			if (this._contentServerTokens[depotID + '_' + hostname] && this._contentServerTokens[depotID + '_' + hostname].expires - Date.now() > (1000 * 60 * 60)) {
				return resolve(this._contentServerTokens[depotID + '_' + hostname]);
			}

			this._send2(EMsg.ClientGetCDNAuthToken, {
				app_id: appID,
				depot_id: depotID,
				host_name: hostname
			}, (body) => {
...
download('http://dl.steam.clngaa.com/depot/1172477/manifest/6073283353751140054/5/12829838803131247302?t=1715650429&k=44feb7d9e01a41d63b66fa5a459127ea','dl.steam.clngaa.com','E:/temp/file', async (err, res) => {
	if (err) {
