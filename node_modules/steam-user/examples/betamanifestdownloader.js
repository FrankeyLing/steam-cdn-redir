...
const BRANCH_NAME = 'public';                // The name of the password-protected beta branch
const BRANCH_PASSWORD = 'password';        // The password for the branch

const STEAM_ACCOUNT_NAME = 'frankeyling01';         // Username for your Steam account
const STEAM_ACCOUNT_PASSWORD = 'lsx763186988123'; // Password for your Steam account
